...
|---|---:|---|
| `reviewers/<agent>/review.draft.json`, `reviewers/<agent>/review.json` | 2 | `REVIEW_OUTPUT_SCHEMA` — `scripts/review/agent/output.py` |
...
| `review_run_metrics.py --format json` report | 4 | `_REPORT_SCHEMA` — `scripts/analysis/review_metrics/contracts.py` |
