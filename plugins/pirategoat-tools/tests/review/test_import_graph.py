...
LEAF_MODULES = ("review_document.py", "verdict_rules.py", "run_paths.py", "triage_sources.py", "change_purpose.py")
LEAF_ALLOWED = frozenset({"review_document", "verdict_rules", "run_paths", "triage_sources", "change_purpose"})
