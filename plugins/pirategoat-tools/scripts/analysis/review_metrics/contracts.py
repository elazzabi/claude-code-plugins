...
_CHANGED_FILES_FIELD = _MANIFEST_SECTIONS_CONTRACT.CHANGED_FILES
_REVIEWABLE_FILES_FIELD = _MANIFEST_SECTIONS_CONTRACT.REVIEWABLE_FILES
_ASSIGNED_FILES_BY_AGENT_FIELD = (
    _MANIFEST_SECTIONS_CONTRACT.ASSIGNED_FILES_BY_AGENT
)
_ASSIGNED_FILES_FIELD = _MANIFEST_SECTIONS_CONTRACT.ASSIGNED_FILES
_FILE_EXCLUSIONS_FIELD = _MANIFEST_SECTIONS_CONTRACT.FILE_EXCLUSIONS
_UNASSIGNED_REVIEWABLE_FILES_FIELD = (
    _MANIFEST_SECTIONS_CONTRACT.UNASSIGNED_REVIEWABLE_FILES
)
_ASSIGNMENT_FIELDS = _MANIFEST_SECTIONS_CONTRACT.ASSIGNMENT_FIELDS
_ASSIGNMENT_PATH_LIST_FIELDS = (
    _MANIFEST_SECTIONS_CONTRACT.ASSIGNMENT_PATH_LIST_FIELDS
)
_ASSIGNMENT_COUNTABLE_LIST_FIELDS = (
    _MANIFEST_SECTIONS_CONTRACT.ASSIGNMENT_COUNTABLE_LIST_FIELDS
)
_ASSIGNMENT_TABLE_FIELDS = (
    _MANIFEST_SECTIONS_CONTRACT.ASSIGNMENT_TABLE_FIELDS
)
...
# reviewed-files projection in every assignment section.
